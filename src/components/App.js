      ...
      <Baselayout >
        <div className="body" >
          <div id="mission" className="bio">
            ...
            <p>From fully functional websites to throwing ceramic mugs or brewing beer, I'm never happier than when I'm making something.  I am driven to solve problems; my pragmatism helps me find and define a goal, and my creativity, focus on details, and analytical mind become the means to accomplishing that end.  I am comfortable writing code, explaining technical concepts to clients, colleagues, my friends or family, throwing on a potters wheel, and running.  I am friendly and approachable, and always ready to go the extra mile to help out.</p>
          </div>
          <div id="techno">
            <Technologies />
          </div>
